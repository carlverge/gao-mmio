...
#define GAO_GRIDS			256
GAO_ASSERT_POW2(GAO_GRIDS);
#define GAO_GRID_SIZE		1024
GAO_ASSERT_POW2(GAO_GRID_SIZE);
#define GAO_GRID_ORDER		10
GAO_ASSERT_LOG2(GAO_GRID_ORDER, GAO_GRID_SIZE);


//Queues
#define GAO_MAX_QUEUE_ORDER			16
#define GAO_MIN_QUEUE_ORDER			8
#define GAO_DEFAULT_QUEUE_ORDER		12
